...
class Kernel:
    """Owns OS identity, lifecycle, and slots for later subsystems.

    Filesystem, processes, memory, users, and networking are not implemented
    yet. Those managers will be attached through ``components``.
    """
